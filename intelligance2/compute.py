...
def fetchPreMarket(link,a,b):
    ...
    d=pd.DataFrame({'g':v})
    d.to_excel('/home/tatar/Yandex.Disk/Java_study/market3/intelligance2/Data/m.xlsx')

    return d

while True:
    a = pd.read_excel('/home/tatar/Yandex.Disk/Java_study/market3/intelligance2/Data/Data_mlv_rost_multireg_perebor.xlsx')
    b=pd.read_excel('/home/tatar/Yandex.Disk/Java_study/market3/intelligance2/Data/Data_mlv_rost_multireg_perebor.xlsx')
    b.columns= \
    ...
    a1=pd.read_excel('/home/tatar/Yandex.Disk/Java_study/market3/intelligance2/Data/m.xlsx')
